...
print "\t\t\t MENCARI PHPmyadmin v.1.0\n";
print "\t\t\t BAHASA INDONESIA VERSION\n";
print "\t\t_________________________________________________\n";
print "\n\n";
sleep (1);
    print "\n\n";
    print "\t CONTOH WEBSITE TARGET=> (ex: http://www.site.com)\n";
    print "\t MASUKKAN WEBSITE TARGET=> :";
    $host=<STDIN>;
    chomp($host);
    if($host !~ /http:\/\//) { $host = "http://$host"; };

print "\n\n";
print "\t\t*-*-*-*-*-* Mencari Web Admin *-*-*-*-*-*\n";
print "\n\n";
@p = ("/phpMyAdmin/",
"/phpmyadmin/",
"/PMA/",
...
if ($response->content=~ /Access Denied/){print "BERHASIL DITEMUKAN : $url =>[Error & Access Denied]\n";}
else {print "TIDAK DITEMUKAN : $myadmin\n";}
